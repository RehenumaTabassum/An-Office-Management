                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="min-width: 1000px;">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#"
                                style="text-decoration: none; display: inline-flex; margin-top: 0.2rem; margin-left: 1rem;">R&S WorkSpace Hub
                                </a>
                        ...
                        <li class="nav-item dropdown">
                            <a href="activities.php"
                                style="color:#990000; text-decoration: none; display: inline-flex; margin-top: 0.2rem; margin-left: 1rem;">Activities</a>
                            <a class="nav-link dropdown-toggle ps-0" href="#" id="navbarDropdownMenuLink"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                style="display: inline-flex;">
                            </a>
    ...
    <div class="container mt-5" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 10px;">
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="card">
                    <img src="images/Officems.jpg" class="rounded" alt="...">
                </div>
            </div>
            <div class="col-lg-6 p-5">
                <h4 class="mb-3 font-weight-bold">OurActivities</h4>
                <hr allign="center"
                    style="height:6px; width:8%; background-color:#990000; margin-top: 3px; margin-bottom:20px;">
                <p class="fs-6">
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Projects
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Web development
                    <br>
                    <br>
                    <i class="fa fa-arrow-right" style="color:#02b321;"></i>&nbsp; Software
                    <br>
				...
				<div class="col-md-5 col-lg-5 col-xl-3 mx-auto mt-3" style="padding: 0rem 4rem;">
					...
					<ul class="list-unstyled list-inline">
						<li class="list-inline-item">
							<a href="https://www.facebook.com/rehenuma.rashid23/" class="btn-floating btn-sm text-white" style="font-size: 23px;"><i
									class="fab fa-facebook"></i></a>
						</li>
						<li class="list-inline-item">
							<a href="https://twitter.com/r&sworkspacehub.org.bd" class="btn-floating btn-sm text-white" style="font-size: 23px;"><i
									class="fab fa-twitter"></i></a>
						</li>
						<li class="list-inline-item">
							<a href="https://www.linkedin.com/in/r&sworkspacehub.org.bd" class="btn-floating btn-sm text-white" style="font-size: 23px;"><i
									class="fab fa-linkedin-in"></i></a>
						</li>
						<li class="list-inline-item">
